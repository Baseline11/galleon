...
var _jsxFileName = 'src/containers/AddUser/AddUser.js';
...
function mapDispatchToProps(dispatch) {
  return {
    actionCreators: (0, _redux.bindActionCreators)({
      fetchInvitationText: _adminUser.fetchInvitationText,
...
var AddUser = function (_Component) {
  ...
  function AddUser() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddUser.__proto__ || Object.getPrototypeOf(AddUser)).call.apply(_ref, [this].concat(args))), _this), _this.handleSaveEdit = function () {
      return _this.props.actionCreators.saveAdminUser('addUser');
  ...
  _createClass(AddUser, [{
    ...
    value: function componentDidMount() {
      this.props.actionCreators.fetchInvitationText();
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        }) : _react2.default.createElement(_AddForm2.default, { onSubmit: this.handleSaveEdit, __source: {
            fileName: _jsxFileName,
            lineNumber: 42
          }
        })
